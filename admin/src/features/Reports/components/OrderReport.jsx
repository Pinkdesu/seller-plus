...
import { getOrderReport, resetReport, getOrderPeriod } from '../store/events';
...
const OrderReport = () => {
  ...
  const pending = useStore(getOrderReport.pending);
  ...
  const handleClick = () => {
    getOrderReport({ periodFrom, periodTo });
  };
      ...
      <Container className={classes.formWrapper}>
        ...
        <div className={classes.tableWrapper}>
          {Boolean(report.length) && (
            <DataTable columns={ORDER_COLUMNS} data={report} />
          )}
        </div>
      </Container>
    </div>
