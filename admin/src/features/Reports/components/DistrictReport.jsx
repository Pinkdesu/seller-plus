...
import { DISTRICT_COLUMNS } from '../constants';
import { getDistrictReport, resetReport, getPeriod } from '../store/events';
...
const DistrictReport = () => {
  ...
  const pending = useStore(getDistrictReport.pending);
  ...
  const handleClick = () => {
    getDistrictReport({ periodFrom, periodTo });
  };
      ...
      <Container className={classes.formWrapper}>
        ...
        <div className={classes.tableWrapper}>
          {Boolean(report.length) && (
            <DataTable columns={DISTRICT_COLUMNS} data={report} />
          )}
        </div>
      </Container>
    </div>
